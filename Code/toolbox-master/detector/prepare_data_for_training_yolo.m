...
%% run detector on easy test images and save patches
%%imgNms=bbGt('getFiles',{[dataDir 'new_easy_set/pos']});
%%txtNms=bbGt('getFiles',{[dataDir 'new_easy_set/posGt']});
%%save_patches(detector,imgNms, txtNms);

%% run detector on moderate test images and save patches
%%imgNms=bbGt('getFiles',{[dataDir 'new_moderate_set/pos']});
%%txtNms=bbGt('getFiles',{[dataDir 'new_moderate_set/posGt']});
%%save_patches(detector,imgNms, txtNms);

%% run detector on hard test images and save patches
%%imgNms=bbGt('getFiles',{[dataDir 'new_hard_set/pos']});
%%txtNms=bbGt('getFiles',{[dataDir 'new_hard_set/posGt']});
%%save_patches(detector,imgNms, txtNms);
